...
## デモサイト
🔗 https://ai-geoguess-prototype-fazmfx2f2estgcsoxecewr.streamlit.app/ 

※ 初回アクセス時はサーバー起動に数十秒かかる場合があります。
...
## AIモデルと学習概要
CLIP事前学習済みの Vision Transformer（ViT-Base, Patch16, 224）をファインチューニングしています。
世界の景色画像10万枚をデータに、国分類の学習を行いました。
